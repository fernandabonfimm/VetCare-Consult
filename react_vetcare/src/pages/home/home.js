...
function SelectAnimal() {
  ...
  <div class="header-container">
    <div class="div-logo-header">
      <img src={LogoEscura} alt="VetCare Consult Logo" class="logo-header" />
    </div>
  ...
  <section id="schedules" class="schedules-container">
    <div class="div-section-title bg-yellow">
      ...
      <span class="description-section tx-white">Faça aqui mesmo, é rapidinho!</span>
    ...
    <div class="div-form-schedules">
      <div class="div-chose-animal">
        ...
        <div class="div-row-cards">
          <div class="card-chose-animal" onclick="selectAnimal('cat')" data-animal="cat">
          ...
          <div class="card-chose-animal" onclick="selectAnimal('dog')" data-animal="dog">
            <div class="div-card-img">
        ...
        <div class="div-row-cards">
          <div class="card-chose-animal" onclick="selectAnimal('small-animal')" data-animal="small-animal">
            <div class="div-card-img">
          ...
          <div class="card-chose-animal" onclick="selectAnimal('big-animal')" data-animal="big-animal">
            <div class="div-card-img">
      ...
      <div class="div-form-schedules-info">
        <form method="post" action="" class="form-schedules">
          <div class="container-input-label">
            <label for="name" class="label">Nome do tutor ou companhia:</label>
            <input type="text" id="name" name="name" class="input"
              placeholder="Digite aqui o nome do tutor/companhia..." maxlength="150" required />
          </div>
          <div class="container-input-label">
            <label for="animal-name" class="label">Nome do animal ou código:</label>
            <input type="text" id="animal-name" name="animal-name" class="input"
              placeholder="Digite aqui o nome do animal/código..." maxlength="150" required />
          </div>
          <div class="container-input-label">
            <label for="phone" class="label">Telefone para contato:</label>
            <input type="text" id="phone" name="phone" class="input" placeholder="Ex: (99) 99999-9999" required />
          </div>
          <div class="container-input-label">
            <label for="email" class="label">E-mail para contato:</label>
            <input type="email" id="email" name="email" class="input" placeholder="Ex: example@example.com" required />
            <span class="error-message" id="email-error">E-mail esta no formato incorreto! ex:
              example@example.com</span>
          </div>
          <div class="flex-two-inputs">
            <div class="middle-div">
              <div class="container-input-label">
                <label for="data" class="label">Data de Agendamento:</label>
                <input type="date" id="data" name="data" class="input" required />
                <span class="error-message" id="data-error">Escolha ao menos uma data de agendamento maior do que o dia
                  atual.</span>
              </div>
            </div>
            <div class="middle-div">
              <div class="container-input-label">
                ...
                <input type="time" id="hour" name="hour" class="input" required />
              </div>
            </div>
          </div>
          ...
          <div class="flex-two-inputs">
            <div class="middle-div">
              <div class="container-input-label">
                <label for="speciality" class="label">Especialidade:</label>
                <select id="speciality" name="speciality" class="input" required>
                ...
                <span class="error-message" id="speciality-error">Escolha uma especialidade para o agendamento.</span>
              </div>
            </div>
            <div class="middle-div">
              <div class="container-input-label">
                ...
                <span class="error-message" id="unit-error">Escolha uma unidade para o agendamento.</span>
              </div>
            </div>
          </div>
  ...
  <section id="speciality" class="speciality-container">
    <div class="div-section-title bg-yellow">
      ...
      <span class="description-section tx-white">Conheça os especialistas presentes na VetCare Consult</span>
      <div class="divider-horizontal bg-white"></div>
    </div>
  ...
  <section id="plans" class="plans-container">
    <div class="div-section-title bg-darkgreen">
      ...
      <span class="description-section tx-white">Os planos são exclusivos para medicos veterinários e clínicas</span>
      <div class="divider-horizontal bg-white"></div>
    </div>
    <div class="content-all-plans bg-green">
      <div class="card-plan">
        ...
        <div class="card-plan-info">
          ...
          <ul>
            <li>
              Agendamento online 24/7 para consultas e serviços veterinários.
            </li>
            <li>
      ...
      <div class="card-plan">
        ...
        <div class="card-plan-info">
          <h1>Franquias</h1>
          <span>
            Este plano premium é projetado para franquias que buscam alcançar
            excelência em todos os aspectos, desde a experiência do cliente
  ...
  <section id="newsletter" class="newsletter-container">
    <div class="card-newsletter">
      ...
      <div class="container-input-label-card">
        ...
        <input type="text" id="name-newsletter" name="name-newsletter"
          placeholder="Digite aqui o nome completo ou da companhia..." maxlength="150" required />
      </div>
      <div class="container-input-label-card">
        <label>E-mail:</label>
        <input type="email" id="email-newsletter" name="email-newsletter" placeholder="Ex: example@example.com..."
          required />
      </div>
  ...
  <div id="myModal" class="modal">
    ...
    <div class="divider-modal" style={{marginTop: "20px", marginBottom: "16px"}}></div>
  ...
  <footer class="footer-copyright">
    <span>Copyright ® 2024 VETCARE CONSULT - Todos os direitos reservados
    </span>
  </footer>
</body>
  );
